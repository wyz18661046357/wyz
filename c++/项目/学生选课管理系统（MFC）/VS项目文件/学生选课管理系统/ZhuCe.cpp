...
BOOL ZhuCe::OnInitDialog()
{
	...
	CWnd* pWnd = GetDlgItem(IDC_ZhuCeWenBen);
...
int ZhuCe::CalcCount(int n, char(*str)[10])//读出一共有多少个学生注册
{
...
void ZhuCe::OnBnClickedOk()
{
	...
	{
		cout++;
	    CString Du_Chu_Zhu_Ce_Xue_Sheng_Ren_Shu;
	    Du_Chu_Zhu_Ce_Xue_Sheng_Ren_Shu.Format(L" % d", cout);
		CString str_Zhang_Hao;  str_Zhang_Hao = a;
		WritePrivateProfileString(Du_Chu_Zhu_Ce_Xue_Sheng_Ren_Shu, L"Zhang_Hao", str_Zhang_Hao, L"D:\\学生选课管理系统\\账号密码信息\\学生账号信息.ini");
		CString str_Mi_Ma;  str_Mi_Ma = b;
		WritePrivateProfileString(Du_Chu_Zhu_Ce_Xue_Sheng_Ren_Shu, L"Mi_Ma", str_Mi_Ma, L"D:\\学生选课管理系统\\账号密码信息\\学生账号信息.ini");
		CDialog::OnOK();
	}
}
